...
\begin{figure}
 ...
 \caption{An example interferogram for Q=40 nC and laser pulse FWHM of 1.5 ps.}
 \label{interferogram}
\end{figure}
...
\begin{table}[hbt]
	...
	\begin{tabular}{lcc}
		...
		Gun Phase    & \SI{0}{}$^{\circ}$ & \SI{-20}{}$^{\circ}$ \\		 
		$S_1$        & \SI{230}{A}		 & \SI{500}{A}	  \\
		$S_2$		 & \SI{150}{A}   	 & \SI{185}{A}		 \\
...
on 8 cores. Prior work \cite{benchmark} has indicated the the bunch length is not 
...
The bunch length for the cases of 1 and \SI{40}{nC} is reported.
...
\bibitem{benchmark}
N.~Neveu \emph{et al.}, “Demonstration of Current Profile 
Shaping using Double Dog-Leg Emittance Exchange Beam 
Line at Argonne Wakefield Accelerator”
in \textit{Proc. IPAC’16}, 
Busan, South Korea, May 2016, 
